...
(function() {
	...
	var MODULE = angular.module('my.iot',
			[ 'ngRoute', 'ngResource' ]);

	MODULE.config( function($routeProvider) {
		$routeProvider.when('/', { controller: mainProvider, templateUrl: '/my.iot/main/htm/home.htm'});
		$routeProvider.when('/about', { templateUrl: '/my.iot/main/htm/about.htm'});
